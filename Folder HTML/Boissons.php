...
<body>
    ...
    <!-- La notification panier apparaît seulement si le client a déjà ajouté au moins un article. -->
    ...
    <header class="top_bar">
        ...
        <aside>
            <!-- Si le client est connecté, on affiche son profil, sinon, on propose la connexion. -->
            <?php if ($connecte) : ?>
    ...
    <main>
        <div class="rect-menus">
            ...
            <?php else: ?>
                <!-- $plat contient tout le catalogue, cette page n'affiche que les produits de type boisson. -->
                    ...
                    <div class="menu-item">
                        ...
                        <div style="position: relative; flex-shrink: 0;">
                            <img src="<?= htmlspecialchars($p['image']) ?>"
                                 ...
                                 class="menu-image">
                            <!-- Le bouton + transmet le nom et le prix à ajouter_panier.php pour ajouter la boisson au panier. -->
